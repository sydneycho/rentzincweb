...
import 'searchc_model.dart';
export 'searchc_model.dart';
...
class _SearchcWidgetState extends State<SearchcWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SearchcModel());
                  ...
                  child: Container(
                    width: () {
                      if (MediaQuery.sizeOf(context).width < kBreakpointSmall) {
                        return 330.0;
                      } else if (MediaQuery.sizeOf(context).width < 850.0) {
                        return 700.0;
                      } else if (MediaQuery.sizeOf(context).width >= 850.0) {
                        return 800.0;
                      } else {
                    ...
                    Padding(
                      ...
                      child: StreamBuilder<List<CarRecord>>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          List<CarRecord> textCarRecordList = snapshot.data!;
                          return Text(
                            formatNumber(
                              textCarRecordList.length,

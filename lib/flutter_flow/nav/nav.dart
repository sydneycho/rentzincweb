...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) => RootPageContext.wrap(
        appStateNotifier.loggedIn ? HomeWidget() : IndexWidget(),
      ...
      routes: [
        ...
        FFRoute(
          name: 'Askedquestion',
          path: '/askedquestion',
          builder: (context, params) => AskedquestionWidget(),
        ),
        FFRoute(
          name: 'MyActivities',
          path: '/myActivities',
        ...
        FFRoute(
          ...
          builder: (context, params) => DetailsWidget(
            car: params
                .getParam('car', ParamType.DocumentReference, false, ['Car']),
          ),
        ),
        FFRoute(
          name: 'Chat',
        ...
        FFRoute(
          ...
          builder: (context, params) => ReviewsWidget(
            carrefreview: params.getParam(
                'carrefreview', ParamType.DocumentReference, false, ['Car']),
          ),
        ),
        FFRoute(
          name: 'Login',
        ...
        FFRoute(
          ...
          path: '/bookingAlert',
          requireAuth: true,
          builder: (context, params) => BookingAlertWidget(),
        )
